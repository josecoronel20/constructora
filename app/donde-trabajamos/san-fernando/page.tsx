...
export default function SanFernando() {
  const servicios = [
    ...
    },
    {
      ...
      slug: "techos",
      icon: "🏠",
      titulo: "Techos y Zinguería en San Fernando",
      descripcion: "Reparación de techos y zinguería en San Fernando. Reparación de chapas, colocación de nuevas chapas, canaletas, bajadas, babeta, cumbreras, aislaciones y mantenimiento anual. Protección completa para tu hogar.",
      serviciosPrincipales: [
