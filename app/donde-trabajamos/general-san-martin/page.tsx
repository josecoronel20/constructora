...
export default function GeneralSanMartin() {
  const servicios = [
    ...
    },
    {
      ...
      slug: "zingueria",
      icon: "📐",
      titulo: "Zinguería en General San Martín",
      descripcion: "Servicios de zinguería en General San Martín. Canaletas, bajadas pluviales, cumbreras y soluciones contra filtraciones. Protección completa para tu techo.",
      serviciosPrincipales: [
    ...
    },
    {
      ...
      slug: "techos",
      icon: "🏠",
      titulo: "Techos en General San Martín",
      descripcion: "Reparación y mantenimiento de techos en General San Martín. Reparación de chapas, colocación de nuevas chapas, aislaciones y mantenimiento anual. Protección completa para tu hogar.",
      serviciosPrincipales: [
