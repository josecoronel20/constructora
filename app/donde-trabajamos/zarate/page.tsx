...
export default function Zarate() {
  const servicios = [
    ...
    },
    {
      ...
      slug: "techos",
      icon: "🏠",
      titulo: "Techos y Zinguería en Zárate",
      descripcion: "Reparación de techos y zinguería en Zárate. Reparación de chapas, colocación de nuevas chapas, canaletas, bajadas, babeta, cumbreras, aislaciones y mantenimiento anual. Protección completa para tu hogar.",
      serviciosPrincipales: [
