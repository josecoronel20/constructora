...
export const metadata: Metadata = {
  title: "Pintor en Zona Norte – Profesionales Certificados | Pintura Interior y Exterior",
  description: "Pintor en Zona Norte. Soluciones rápidas y garantizadas en hogares. Pintura interior, exterior, empastinado, tratamientos antihumedad, pintura de rejas y más. Atención en Pilar, San Isidro, Tigre y toda Zona Norte.",
  keywords: "pintor zona norte, pintor pilar, pintor san isidro, pintura interior zona norte, pintura exterior zona norte, empastinado zona norte",
};
...
export default function Pintura() {
  const serviciosIncluidos = [
    "Pintura interior",
    "Pintura exterior",
    "Empastinado y preparación de superficies",
    "Aplicación de selladores y fijadores",
    "Tratamientos antihumedad",
    "Pintura de rejas, portones y herrería",
    "Pintura de techos y frentes",
  ];
  ...
  const ejemplosTrabajos = [
    {
      titulo: "Pintura completa de vivienda",
      descripcion: "Pintura interior y exterior de toda la casa. Preparación profesional de superficies, empastinado y terminación de primera calidad.",
      icon: "🎨",
    },
    {
      titulo: "Tratamientos antihumedad",
      descripcion: "Solución definitiva para problemas de humedad. Aplicación de productos especiales y selladores para proteger tu hogar.",
      icon: "🛡️",
    },
    {
      titulo: "Pintura de rejas y herrería",
      descripcion: "Pintura profesional de rejas, portones y estructuras metálicas. Preparación, tratamiento antióxido y terminación duradera.",
      icon: "🔩",
    },
    {
      titulo: "Empastinado y preparación",
      descripcion: "Preparación profesional de paredes antes de pintar. Empastinado, lijado y aplicación de selladores para un acabado perfecto.",
      icon: "✨",
    },
  ];
    ...
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Pintor en Zona Norte – Profesionales Certificados
              </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              ¿Necesitás <strong className="text-[#0A2A43]">pintar tu casa</strong> o 
              <strong className="text-[#0A2A43]"> renovar la pintura exterior</strong>? 
              ¿Tenés <strong className="text-[#0A2A43]">problemas de humedad</strong> que requieren tratamiento especial o 
              <strong className="text-[#0A2A43]"> rejas y portones</strong> que necesitan pintura?
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              Como <strong className="text-[#0A2A43]">pintor en Zona Norte</strong>, resolvemos todos estos trabajos 
              con profesionalismo y calidad. Trabajamos con <strong className="text-[#0A2A43]">pintura interior y exterior</strong>, 
              <strong className="text-[#0A2A43]"> empastinado y preparación de superficies</strong>, 
              <strong className="text-[#0A2A43]"> tratamientos antihumedad</strong> y 
              <strong className="text-[#0A2A43]"> pintura de rejas, portones y herrería</strong>.
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed">
              Nuestros <strong className="text-[#0A2A43]">pintores certificados en Zona Norte</strong> están especializados 
              en trabajos de pintura residencial, preparación profesional de superficies y tratamientos especiales. Desde la 
              pintura completa de una vivienda hasta el empastinado y tratamiento de humedad, ofrecemos soluciones profesionales, 
              con materiales de primera calidad y garantía escrita en todos nuestros trabajos.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Servicios de Pintura que Ofrecemos
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Como pintor en Zona Norte, cubrimos todas las necesidades de pintura de tu hogar, 
            desde trabajos interiores hasta pintura exterior y tratamientos especiales.
          </p>
      ...
      <section className="bg-white py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-12 text-center">
            Por qué elegirnos como tu pintor en Zona Norte
          </h2>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Ejemplos de proyectos típicos que realizamos como pintores en Zona Norte
          </p>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Pintor en todas las localidades de Zona Norte
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Atendemos como pintores en todas las localidades de Zona Norte. 
      ...
      <section className="bg-[#0A2A43] text-white py-16 md:py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ¿Necesitás un pintor en Zona Norte?
          </h2>
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
