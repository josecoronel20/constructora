...
export const metadata: Metadata = {
  title: "Instalación de Aire Acondicionado en Zona Norte – Profesionales Certificados | Split y Mantenimiento",
  description: "Instalación de aire acondicionado en Zona Norte. Soluciones rápidas y garantizadas en hogares. Instalación split, mantenimiento preventivo, recarga de gas, limpieza profunda y más. Atención en Pilar, San Isidro, Tigre y toda Zona Norte.",
  keywords: "aire acondicionado zona norte, instalacion aire acondicionado pilar, aire acondicionado san isidro, split zona norte, recarga gas aire acondicionado zona norte",
};
  ...
  const ejemplosTrabajos = [
    {
      ...
      descripcion: "Instalación profesional de equipos split. Conexión eléctrica, drenaje, soportes y configuración completa del sistema.",
      icon: "❄️",
    },
    {
      titulo: "Mantenimiento preventivo",
      descripcion: "Mantenimiento periódico para mantener tu aire acondicionado funcionando perfectamente. Limpieza, revisión y ajustes.",
      icon: "🔧",
    },
    {
      titulo: "Recarga de gas y reparaciones",
      descripcion: "Recarga de gas refrigerante y reparación de fallas. Diagnóstico profesional y solución garantizada.",
      icon: "⚡",
    },
    {
      titulo: "Limpieza profunda y reubicación",
      descripcion: "Limpieza profunda de equipos y reubicación de aires acondicionados. Servicio completo y profesional.",
      icon: "🧹",
    },
  ];
    ...
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Instalación de Aire Acondicionado en Zona Norte – Profesionales Certificados
              </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              ¿Necesitás <strong className="text-[#0A2A43]">instalar un aire acondicionado split</strong> o 
              <strong className="text-[#0A2A43]"> hacer mantenimiento</strong> de tu equipo? 
              ¿Tu <strong className="text-[#0A2A43]">aire no enfría correctamente</strong> y necesita 
              <strong className="text-[#0A2A43]"> recarga de gas</strong>? 
              ¿Querés <strong className="text-[#0A2A43]">limpiar profundamente</strong> tu equipo o 
              <strong className="text-[#0A2A43]"> reubicarlo</strong>?
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              Como <strong className="text-[#0A2A43]">especialistas en instalación de aire acondicionado en Zona Norte</strong>, resolvemos todos estos trabajos 
              con profesionalismo y calidad. Trabajamos con <strong className="text-[#0A2A43]">instalación de split</strong>, 
              <strong className="text-[#0A2A43]"> mantenimiento preventivo</strong>, 
              <strong className="text-[#0A2A43]"> recarga de gas refrigerante</strong> y 
              <strong className="text-[#0A2A43]"> limpieza profunda de equipos</strong>.
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed">
              Nuestros <strong className="text-[#0A2A43]">técnicos certificados en aire acondicionado en Zona Norte</strong> están especializados 
              en instalación, mantenimiento y reparación de equipos split para viviendas particulares. Desde la instalación completa de un nuevo 
              equipo hasta el mantenimiento preventivo y la recarga de gas, ofrecemos soluciones profesionales, con materiales de primera calidad 
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Servicios de Aire Acondicionado que Ofrecemos
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Como especialistas en aire acondicionado en Zona Norte, cubrimos todas las necesidades de instalación, 
            mantenimiento y reparación de equipos split para tu hogar.
          </p>
      ...
      <section className="bg-white py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-12 text-center">
            Por qué elegirnos para aire acondicionado en Zona Norte
          </h2>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Ejemplos de proyectos típicos que realizamos en instalación y mantenimiento de aire acondicionado en Zona Norte
          </p>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Aire acondicionado en todas las localidades de Zona Norte
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Atendemos servicios de aire acondicionado en todas las localidades de Zona Norte. 
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-base md:text-lg font-semibold text-[#0A2A43] group-hover:text-[#3F6E8F] transition-colors">
                    Aire acondicionado en {localidad}
                  </h3>
      ...
      <section className="bg-[#0A2A43] text-white py-16 md:py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ¿Necesitás instalar o reparar tu aire acondicionado en Zona Norte?
          </h2>
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
