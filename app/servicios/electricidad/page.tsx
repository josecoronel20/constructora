...
export async function generateMetadata(): Promise<Metadata> {
  const serviceData = getServiceData("electricidad");
  if (!serviceData) {
    return genMeta({
      title: "Electricista en Zona Norte",
      description: "Servicios de electricidad en Zona Norte",
    });
  }
...
export default function Electricidad() {
  ...
  // Encontrar el bloque de problema-solución
