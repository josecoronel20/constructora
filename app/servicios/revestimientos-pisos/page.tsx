...
export const metadata: Metadata = {
  title: "Revestimientos y Pisos en Zona Norte – Profesionales Certificados | Cerámicos y Porcelanatos",
  description: "Revestimientos y pisos en Zona Norte. Soluciones rápidas y garantizadas en hogares. Colocación de cerámicos, porcelanatos, pisos flotantes, vinílicos, revestimientos de baños y cocinas y más. Atención en Pilar, San Isidro, Tigre y toda Zona Norte.",
  keywords: "revestimientos zona norte, pisos zona norte, ceramicos zona norte, porcelanatos zona norte, pisos flotantes zona norte, revestimientos pilar",
};

export default function RevestimientosPisos() {
  const serviciosIncluidos = [
    "Colocación de cerámicos",
    "Porcelanatos",
    "Revestimientos de baños y cocinas",
    "Pisos flotantes",
    "Pisos vinílicos",
  ...
  const ejemplosTrabajos = [
    {
      titulo: "Revestimientos de baños y cocinas",
      descripcion: "Colocación profesional de cerámicos y porcelanatos en baños y cocinas. Terminaciones perfectas y resistentes a la humedad.",
      icon: "🚿",
    },
    {
      titulo: "Pisos flotantes y vinílicos",
      descripcion: "Instalación de pisos flotantes y vinílicos modernos. Soluciones rápidas, duraderas y de fácil mantenimiento.",
      icon: "🏠",
    },
    {
      titulo: "Porcelanatos y cerámicos",
      descripcion: "Colocación profesional de porcelanatos y cerámicos de alta calidad. Nivelación perfecta y terminaciones impecables.",
      icon: "🔲",
    },
    {
      titulo: "Nivelación de superficies",
      descripcion: "Preparación profesional de superficies antes de colocar revestimientos. Nivelación perfecta para un acabado de calidad.",
      icon: "📐",
    },
  ];
    ...
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Revestimientos y Pisos en Zona Norte – Profesionales Certificados
              </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              ¿Necesitás <strong className="text-[#0A2A43]">revestir tu baño o cocina</strong> o 
              <strong className="text-[#0A2A43]"> cambiar los pisos</strong> de tu hogar? 
              ¿Querés <strong className="text-[#0A2A43]">instalar porcelanatos o cerámicos</strong> o 
              <strong className="text-[#0A2A43]"> colocar pisos flotantes o vinílicos</strong>? 
              ¿Necesitás <strong className="text-[#0A2A43]">nivelar superficies</strong> antes de colocar revestimientos?
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              Como <strong className="text-[#0A2A43]">especialistas en revestimientos y pisos en Zona Norte</strong>, resolvemos todos estos trabajos 
              con profesionalismo y calidad. Trabajamos con <strong className="text-[#0A2A43]">colocación de cerámicos y porcelanatos</strong>, 
              <strong className="text-[#0A2A43]"> revestimientos de baños y cocinas</strong>, 
              <strong className="text-[#0A2A43]"> pisos flotantes y vinílicos</strong> y 
              <strong className="text-[#0A2A43]"> nivelación profesional de superficies</strong>.
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed">
              Nuestros <strong className="text-[#0A2A43]">profesionales certificados en revestimientos y pisos en Zona Norte</strong> están especializados 
              en trabajos de terminación para viviendas particulares. Desde la colocación de cerámicos en un baño hasta la instalación completa 
              de pisos flotantes en toda la casa, ofrecemos soluciones profesionales, con materiales de primera calidad y terminaciones perfectas 
              para tu hogar.
            </p>
          </div>
        </div>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Servicios de Revestimientos y Pisos que Ofrecemos
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Como especialistas en revestimientos y pisos en Zona Norte, cubrimos todas las necesidades de terminación 
            y pisos para tu hogar, desde cerámicos hasta pisos modernos.
          </p>
      ...
      <section className="bg-white py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-12 text-center">
            Por qué elegirnos para revestimientos y pisos en Zona Norte
          </h2>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Ejemplos de proyectos típicos que realizamos en revestimientos y pisos en Zona Norte
          </p>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Revestimientos y pisos en todas las localidades de Zona Norte
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Atendemos servicios de revestimientos y pisos en todas las localidades de Zona Norte. 
      ...
      <section className="bg-[#0A2A43] text-white py-16 md:py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ¿Necesitás revestimientos o pisos en Zona Norte?
          </h2>
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
