...
export async function generateMetadata(): Promise<Metadata> {
  const serviceData = getServiceData("revestimientos-pisos");
  if (!serviceData) {
    return genMeta({
      title: "Revestimientos y Pisos en Zona Norte",
      description: "Servicios de revestimientos y pisos en Zona Norte",
    });
  }
