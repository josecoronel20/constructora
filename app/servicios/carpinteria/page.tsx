...
export const metadata: Metadata = {
  title: "Carpintero en Zona Norte – Profesionales Certificados | Muebles y Reparaciones",
  description: "Carpintero en Zona Norte. Soluciones rápidas y garantizadas en hogares. Muebles a medida, reparación de puertas y ventanas, zócalos, armado de muebles y más. Atención en Pilar, San Isidro, Tigre y toda Zona Norte.",
  keywords: "carpintero zona norte, carpintero pilar, carpintero san isidro, muebles a medida zona norte, carpinteria madera zona norte, reparacion puertas zona norte",
};

export default function Carpinteria() {
  const serviciosIncluidos = [
    "Muebles a medida sencillos",
    "Reparación de puertas y ventanas",
    "Colocación de puertas interiores",
    "Colocación de zócalos",
    "Armado de muebles prefabricados",
    "Decks pequeños y reparaciones",
  ];
  ...
  const ejemplosTrabajos = [
    {
      titulo: "Muebles a medida sencillos",
      descripcion: "Diseño y fabricación de muebles a medida para tu hogar. Estanterías, mesas, repisas y más, adaptados a tus espacios.",
      icon: "🪵",
    },
    {
      titulo: "Reparación de puertas y ventanas",
      descripcion: "Reparación profesional de puertas y ventanas de madera. Ajustes, cambio de bisagras, reparación de marcos y más.",
      icon: "🚪",
    },
    {
      titulo: "Colocación de zócalos y terminaciones",
      descripcion: "Instalación profesional de zócalos de madera. Terminaciones perfectas que dan el toque final a tus ambientes.",
      icon: "📐",
    },
    {
      titulo: "Armado de muebles y decks",
      descripcion: "Armado profesional de muebles prefabricados y construcción de decks pequeños. Trabajos rápidos y de calidad.",
      icon: "🪑",
    },
  ];
    ...
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Carpintero en Zona Norte – Profesionales Certificados
              </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              ¿Necesitás <strong className="text-[#0A2A43]">muebles a medida</strong> o 
              <strong className="text-[#0A2A43]"> reparar puertas y ventanas</strong>? 
              ¿Querés <strong className="text-[#0A2A43]">instalar zócalos</strong> o 
              <strong className="text-[#0A2A43]"> armar muebles prefabricados</strong>? 
              ¿Necesitás <strong className="text-[#0A2A43]">construir un deck pequeño</strong>?
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              Como <strong className="text-[#0A2A43]">carpintero en Zona Norte</strong>, resolvemos todos estos trabajos 
              con profesionalismo y calidad. Trabajamos con <strong className="text-[#0A2A43]">muebles a medida sencillos</strong>, 
              <strong className="text-[#0A2A43]"> reparación de puertas y ventanas</strong>, 
              <strong className="text-[#0A2A43]"> colocación de puertas interiores y zócalos</strong> y 
              <strong className="text-[#0A2A43]"> armado de muebles prefabricados</strong>.
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed">
              Nuestros <strong className="text-[#0A2A43]">carpinteros certificados en Zona Norte</strong> están especializados 
              en trabajos de carpintería de madera para el hogar. Desde la fabricación de muebles a medida hasta la reparación 
              de puertas y ventanas, ofrecemos soluciones profesionales, con materiales de primera calidad y terminaciones 
              perfectas para tu hogar.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Servicios de Carpintería de Madera que Ofrecemos
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Como carpintero en Zona Norte, cubrimos todas las necesidades de carpintería de madera de tu hogar, 
            desde muebles a medida hasta reparaciones y terminaciones.
          </p>
      ...
      <section className="bg-white py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-12 text-center">
            Por qué elegirnos como tu carpintero en Zona Norte
          </h2>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Ejemplos de proyectos típicos que realizamos como carpinteros en Zona Norte
          </p>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Carpintero en todas las localidades de Zona Norte
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Atendemos como carpinteros en todas las localidades de Zona Norte. 
      ...
      <section className="bg-[#0A2A43] text-white py-16 md:py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ¿Necesitás un carpintero en Zona Norte?
          </h2>
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
