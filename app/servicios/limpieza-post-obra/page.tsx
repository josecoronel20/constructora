...
export async function generateMetadata(): Promise<Metadata> {
  const serviceData = getServiceData("limpieza-post-obra");
  if (!serviceData) {
    return genMeta({
      title: "Limpieza Post-Obra en Zona Norte",
      description: "Servicios de limpieza post-obra en Zona Norte",
    });
  }
...
export default function LimpiezaPostObra() {
  const serviceData = getServiceData("limpieza-post-obra");
