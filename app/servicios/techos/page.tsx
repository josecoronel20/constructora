...
export const metadata: Metadata = {
  title: "Reparación de Techos en Zona Norte – Profesionales Certificados | Chapas y Aislaciones",
  description: "Reparación de techos en Zona Norte. Soluciones rápidas y garantizadas en hogares. Reparación de techos de chapa, colocación de chapas nuevas, aislaciones térmicas y acústicas, filtraciones y más. Atención en Pilar, San Isidro, Tigre y toda Zona Norte.",
  keywords: "reparacion techos zona norte, techos chapa zona norte, techos pilar, techos san isidro, aislacion techos zona norte, mantenimiento techos zona norte",
};

export default function Techos() {
  const serviciosIncluidos = [
    "Reparación de techos de chapa",
    "Colocación de chapas nuevas",
    "Aislaciones térmicas y acústicas",
    "Reparación de filtraciones",
    "Revisiones y mantenimiento anual",
  ];
  ...
  const ejemplosTrabajos = [
    {
      titulo: "Reparación completa de techos de chapa",
      descripcion: "Solución definitiva para techos de chapa dañados. Reparación de piezas, sellado de juntas y reemplazo de chapas oxidadas.",
      icon: "🏠",
    },
    {
      titulo: "Colocación de chapas nuevas",
      descripcion: "Instalación profesional de techos de chapa nuevos. Trabajos completos con aislaciones y terminaciones perfectas.",
      icon: "🔨",
    },
    {
      titulo: "Aislaciones térmicas y acústicas",
      descripcion: "Instalación de aislaciones para mejorar el confort de tu hogar. Reducción de temperatura y ruido con materiales de primera.",
      icon: "🌡️",
    },
    {
      titulo: "Mantenimiento preventivo anual",
      descripcion: "Revisiones periódicas y mantenimiento preventivo de techos. Detección temprana de problemas y solución antes de que empeoren.",
      icon: "🔍",
    },
  ];
    ...
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Reparación de Techos en Zona Norte – Profesionales Certificados
              </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              ...
              <strong className="text-[#0A2A43]"> chapas oxidadas o dañadas</strong>? 
              ¿Necesitás <strong className="text-[#0A2A43]">colocar un techo nuevo</strong> o 
              <strong className="text-[#0A2A43]"> mejorar la aislación térmica y acústica</strong>? 
              ¿Tu <strong className="text-[#0A2A43]">techo necesita mantenimiento</strong>?
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              Como <strong className="text-[#0A2A43]">especialistas en reparación de techos en Zona Norte</strong>, resolvemos todos estos problemas 
              con soluciones profesionales y duraderas. Trabajamos con <strong className="text-[#0A2A43]">reparación de techos de chapa</strong>, 
              <strong className="text-[#0A2A43]"> colocación de chapas nuevas</strong>, 
              <strong className="text-[#0A2A43]"> aislaciones térmicas y acústicas</strong> y 
              <strong className="text-[#0A2A43]"> mantenimiento preventivo anual</strong>.
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed">
              Nuestros <strong className="text-[#0A2A43]">profesionales certificados en techos en Zona Norte</strong> están especializados 
              en trabajos de techos para viviendas particulares. Desde la reparación de una filtración urgente hasta la colocación completa 
              de un techo nuevo con aislación, ofrecemos soluciones profesionales, con materiales de primera calidad y garantía escrita 
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Servicios de Techos que Ofrecemos
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Como especialistas en techos en Zona Norte, cubrimos todas las necesidades de reparación, 
            instalación y mantenimiento de techos de chapa para tu hogar.
          </p>
      ...
      <section className="bg-white py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-12 text-center">
            Por qué elegirnos para reparación de techos en Zona Norte
          </h2>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Ejemplos de proyectos típicos que realizamos en reparación de techos en Zona Norte
          </p>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Reparación de techos en todas las localidades de Zona Norte
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Atendemos servicios de reparación de techos en todas las localidades de Zona Norte. 
      ...
      <section className="bg-[#0A2A43] text-white py-16 md:py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ¿Necesitás reparar tu techo en Zona Norte?
          </h2>
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
