...
export const metadata: Metadata = {
  title: "Zinguero en Zona Norte – Profesionales Certificados | Canaletas y Reparaciones",
  description: "Zinguero en Zona Norte. Soluciones rápidas y garantizadas en hogares. Canaletas, bajadas, babeta y cumbreras, reparación de filtraciones en chapas y más. Atención en Pilar, San Isidro, Tigre y toda Zona Norte.",
  keywords: "zinguero zona norte, zinguero pilar, zinguero san isidro, canaletas zona norte, reparacion chapas zona norte, zingueria zona norte",
};

export default function Zingueria() {
  const serviciosIncluidos = [
    "Canaletas",
    "Bajadas",
    "Babeta y cumbreras",
    "Reparación de filtraciones en chapas",
  ...
  const ejemplosTrabajos = [
    {
      titulo: "Instalación de canaletas y bajadas",
      descripcion: "Instalación completa de sistema de canaletas y bajadas pluviales. Solución profesional para el desagüe de agua de lluvia.",
      icon: "🌧️",
    },
    {
      titulo: "Reparación de filtraciones en chapas",
      descripcion: "Solución definitiva para filtraciones en techos de chapa. Reparación de juntas, sellado y reemplazo de piezas dañadas.",
      icon: "🔧",
    },
    {
      titulo: "Babeta y cumbreras",
      descripcion: "Instalación y reparación de babeta y cumbreras. Protección completa de los puntos críticos del techo de chapa.",
      icon: "🏠",
    },
    {
      titulo: "Reemplazo de piezas oxidadas",
      descripcion: "Reemplazo profesional de piezas oxidadas o dañadas. Alineación y fijación correcta para evitar futuros problemas.",
      icon: "⚒️",
    },
  ];
    ...
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Zinguero en Zona Norte – Profesionales Certificados
              </h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              ¿Tenés <strong className="text-[#0A2A43]">filtraciones en tu techo de chapa</strong> o 
              <strong className="text-[#0A2A43]"> problemas con canaletas y bajadas</strong>? 
              ¿Necesitás <strong className="text-[#0A2A43]">instalar canaletas nuevas</strong> o 
              <strong className="text-[#0A2A43]"> reparar piezas oxidadas</strong>? 
              ¿Tu <strong className="text-[#0A2A43]">babeta o cumbreras están dañadas</strong>?
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed mb-4">
              Como <strong className="text-[#0A2A43]">zinguero en Zona Norte</strong>, resolvemos todos estos problemas 
              con soluciones profesionales y duraderas. Trabajamos con <strong className="text-[#0A2A43]">instalación de canaletas y bajadas</strong>, 
              <strong className="text-[#0A2A43]"> reparación de filtraciones en chapas</strong>, 
              <strong className="text-[#0A2A43]"> babeta y cumbreras</strong> y 
              <strong className="text-[#0A2A43]"> reemplazo de piezas oxidadas</strong>.
            </p>
            <p className="text-lg text-[#636B75] leading-relaxed">
              Nuestros <strong className="text-[#0A2A43]">zingueros certificados en Zona Norte</strong> están especializados 
              en trabajos de zinguería para techos de chapa. Desde la instalación completa de un sistema de canaletas hasta la 
              reparación de filtraciones y reemplazo de piezas, ofrecemos soluciones profesionales, con materiales de primera 
              calidad y garantía escrita en todos nuestros trabajos.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Servicios de Zinguería que Ofrecemos
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Como zinguero en Zona Norte, cubrimos todas las necesidades de zinguería de tu hogar, 
      ...
      <section className="bg-white py-16 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-12 text-center">
            Por qué elegirnos como tu zinguero en Zona Norte
          </h2>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Ejemplos de proyectos típicos que realizamos como zingueros en Zona Norte
          </p>
      ...
      <section className="bg-[#F4F5F7] py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3F6E8F] mb-4 text-center">
            Zinguero en todas las localidades de Zona Norte
          </h2>
          <p className="text-center text-[#636B75] mb-12 max-w-3xl mx-auto text-lg">
            Atendemos como zingueros en todas las localidades de Zona Norte. 
      ...
      <section className="bg-[#0A2A43] text-white py-16 md:py-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ¿Necesitás un zinguero en Zona Norte?
          </h2>
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
